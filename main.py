...
def get_args():
    ...
    parser.add_argument("--batch", "-b", default = 8, type = int, required = False, help = "batch size")
    ...
    parser.add_argument("--optim", "-o", default = "SGD", type = str, required = False, help = "Optimizer: SGD or Adam")
    ...
    parser.add_argument("--norm", "-n", default = "l2", type = str, required = False, help = "normalize method")
